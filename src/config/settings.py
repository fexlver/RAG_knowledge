...
class Settings:
    ...
    def from_env(cls, project_root: Path | None = None) -> Settings:
        ...
        return cls(
            ...
            embedding_dimension=_to_int("EMBEDDING_DIMENSION", 1024),
            rerank_model=os.getenv("RERANK_MODEL", "qwen3-rerank"),
            milvus_host=os.getenv("MILVUS_HOST", "127.0.0.1"),
            milvus_port=_to_int("MILVUS_PORT", 19530),
            milvus_collection=os.getenv("MILVUS_COLLECTION", "food_safety_chunks_v2"),
            sqlite_path=sqlite_path,
            upload_dir=upload_dir,
            dense_top_k=_to_int("DENSE_TOP_K", 15),
            lexical_top_k=_to_int("LEXICAL_TOP_K", 15),
            fusion_top_k=_to_int("FUSION_TOP_K", 12),
